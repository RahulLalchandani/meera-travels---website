...
<form action="chngpass.php" method="post" onsubmit="return formValidation()">
...
<div class="form-group">
	<label for="name">
	<input type="password" placeholder="Old Password" style="background:rgba(0,0,0,0.8);color:#fff;" class="form-control" name="op" id="op" required>
	</div>
<div class="form-group">
	<label for="name">
