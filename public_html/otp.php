...
<form action="otpsubmit.php" method="post" onsubmit="return formValidation()">
...
<a href="rotp.php">Resend OTP</a>
	</div>
	
	<input type="Submit" value="Verify OTP" style="width:250;background:rgba(255,255,255,0.8)" class="form-control" name="butt" id="butt">
</div>
